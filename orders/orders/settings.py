...
SECRET_KEY = 'django-insecure-2znlw7c)!bo*9+yay84)f6k8lh@9$!089+uhyz01^2q#7_9(k!'
...
# Настройки социальной авторизации (получать из переменных окружения)
